...
const {user, currentUserFollowing, currentUserFollowers} = defineProps({
    user: {
        type: Object,
        default: () => ({})
    },
...
<template>
    <Head>
        <title>{{ user.name }} following</title>
    </Head>
    <DefaultLayout>
        <div class="px-3">
            ...
            <h1 class="text-xl font-semibold text-center mb-3">Following</h1>
            <ProfileList
